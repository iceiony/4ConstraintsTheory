...
if (WIN32)
    find_path( GLEW_INCLUDE_DIR
        ...
        PATHS
            ...
            $ENV{PROGRAMFILES\(X86\)}/glew/include
    ...
    if(ARCH STREQUAL "x86")
      find_library( GLEW_LIBRARY
          ...
          PATHS
              ...
              $ENV{PROGRAMFILES\(X86\)}/glew/lib/Release
              $ENV{PROGRAMFILES}/glew/lib/Release/x86
              $ENV{PROGRAMFILES\(X86\)}/glew/lib/Release/x86
              $ENV{PROGRAMFILES}/glew/lib/Release/win32
              $ENV{PROGRAMFILES\(X86\)}/glew/lib/Release/win32
      ...
      find_library( GLEW_LIBRARY
          ...
          PATHS
              ...
              $ENV{PROGRAMFILES\(X86\)}/glew/lib/Release/x64
              ${PROJECT_SOURCE_DIR}/extern/glew/bin
